...
public class StudentController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Liste mit den aktuellen Talebes wird zurückgegeben. Wenn die Liste Leer ist existieren keine Talebes"),
            @ApiResponse(responseCode = "500", description = "Beim zurückgeben der Liste ist ein Fehler aufgetreten"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Schüler wurde erfolgreich erstellt"),
            @ApiResponse(responseCode = "500", description = "Beim Erstellen ist ein Fehler aufgetreten. Möglicherweise wurde kein Name eingegeben"),
            @ApiResponse(responseCode = "401", description = "Keine Berechtigung")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Der Name des Schülers wurde geändert"),
            @ApiResponse(responseCode = "500", description = "Beim Updaten ist ein Fehler aufgetreten"),
            @ApiResponse(responseCode = "401", description = "Keine Berechtigung"),
            @ApiResponse(responseCode = "404", description = "Der Student wurde nicht gefunden")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Der Schüler wurde erfolgreich gelöscht"),
            @ApiResponse(responseCode = "500", description = "Beim Löschen ist ein unbekannter Fehler aufgetreten"),
            @ApiResponse(responseCode = "401", description = "Keine Berechtigung"),
            @ApiResponse(responseCode = "404", description = "Der Student wurde nicht gefunden")
    })
